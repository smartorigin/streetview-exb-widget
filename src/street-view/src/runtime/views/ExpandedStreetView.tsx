import { Button, Loading, MobilePanel, LoadingType } from 'jimu-ui';
import { useEffect, useState, type SetStateAction, type Dispatch } from 'react';
import type { WidgetViewType, WidgetViewStateType } from '../types/general';
...
function ExpandedStreetView(props: ExpandedStreetViewProps) {
  ...
  useEffect(() => {
    ...
    const contentWrapper = mobilePanel.querySelector(
    ...
    if (slideButton) {
      (slideButton as HTMLElement).style.cssText =
